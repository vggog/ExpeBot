...
async def step4(callback: CallbackQuery) -> None:
    ...
    await callback.message.answer_video(
        ...
        "<b>Никола Дисней</b>\n"
        "\n"
        "- Создатель неизбитой модели запусков и "
        "продаж на <b>холодный трафик</b> - EXPE \n"
        "\n"
        "- Сделал <b>8,5 млн ₽ за 3 месяца</b>, благодаря EXPE\n"
        "\n"
        "- Обучил 50+ учеников, которые по его модели "
        "зарабатывают <b>системно 1 млн ₽ +</b> на холодном трафике\n"
    )
